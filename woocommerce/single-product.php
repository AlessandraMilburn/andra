    ...
    <div class="col-4 text-center">
      ...
      <div class="my-3 px-3 align-self-center">
        ...
        <form class="cart hover-fade " method="post" enctype="multipart/form-data">
          ...
          <button class="w-75 bg-black white py-2 px-4 light-text" type="submit"> <?php echo esc_html( $product->single_add_to_cart_text() ); ?> </button>
        </form>
      ...
      <div class="row mx-4 my-2">
        ...
        <!--Share Button-->
        <div class="col-4 h-100 d-flex align-self-center justify-content-center">
            <a>
                <u><?php do_action( 'woocommerce_share' ); ?> SHARE</u></a></div>
      </div>      
    </div>
  </section>
